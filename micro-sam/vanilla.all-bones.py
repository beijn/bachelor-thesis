...
model_types = 'vit_b vit_l vit_h vit_b_lm vit_h_lm vit_b_em vit_h_em'.split(' ')
iou_thresh = 0.88

cache_dir = os.path.join(os.path.expanduser('~'), '.cache', 'thesis', 'micro-sam', dataset_id)
...
fig, axs = plt.subplots(7, 4, figsize=(13*4/2, 10*7/2))
plt.tight_layout()
